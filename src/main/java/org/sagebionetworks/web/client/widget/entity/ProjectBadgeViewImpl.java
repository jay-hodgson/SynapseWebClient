...
public class ProjectBadgeViewImpl extends Composite implements ProjectBadgeView {
	...
	@Override
	public void setEntity(final ProjectHeader entityHeader) {
		clear();
	...
	private void entityClicked(ProjectHeader entityHeader, ClickEvent event) {
