...
public class AccessControlListEditor implements AccessControlListEditorView.Presenter {
	...
	private void setViewDetails() {
		...
		boolean isEntityOpenData = uep.getIsEntityOpenData();
		view.buildWindow(entity instanceof Project, isInherited, acl.getId(), isEntityOpenData, canEnableInheritance, canChangePermission, PermissionLevel.CAN_DOWNLOAD, authenticationController.isLoggedIn());
		populateAclEntries();
