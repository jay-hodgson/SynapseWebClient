...
public class SubscribeAllButtonWidget implements SubscribeButtonWidgetView.Presenter, SynapseWidgetPresenter {
	...
	boolean iconOnly;
	@Inject
	public SubscribeAllButtonWidget(SubscribeButtonWidgetView view, 
			SubscriptionClientAsync subscribeClient,
			SynapseAlert synAlert,
			AuthenticationController authController,
			GlobalApplicationState globalApplicationState) {
	...
	public SubscribeAllButtonWidget showIconOnly() {
		iconOnly = true;
		return this;
	}
