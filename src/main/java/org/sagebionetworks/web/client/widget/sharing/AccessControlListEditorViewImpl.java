...
public class AccessControlListEditorViewImpl extends FlowPanel implements AccessControlListEditorView {
	...
	@Override
	public void buildWindow(boolean isProject, boolean isInherited, String aclEntityId, boolean isEntityOpenData, boolean canEnableInheritance, boolean canChangePermission, PermissionLevel defaultPermissionLevel, boolean isLoggedIn) {
		clear();
		...
		getSharingPermissionsGrid().configure(removeUserCallback, setAccessCallback, isEntityOpenData);
