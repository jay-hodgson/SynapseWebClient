...
public class SubscribeAllButtonWidgetViewImpl implements SubscribeButtonWidgetView{
	...
	public interface Binder extends UiBinder<Widget, SubscribeAllButtonWidgetViewImpl> {
	}
	...
	@Inject
	public SubscribeAllButtonWidgetViewImpl(Binder binder){
