...
import org.sagebionetworks.web.client.view.WelcomeView;
...
public class WelcomePresenter extends AbstractActivity implements WelcomeView.Presenter, Presenter<Welcome> {
	...
	@Override
	public void setPlace(Welcome place) {
		this.place = place;		
